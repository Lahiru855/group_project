...
<button class="tablink" onclick="openPage('reservations', this, 'blue')" id="defaultOpen">My Reservations</button>
...
<button class="tablink" onclick="openPage('vehicle', this, 'blue')">Vehicle</button>
